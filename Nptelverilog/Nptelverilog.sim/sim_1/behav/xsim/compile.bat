...
REM
REM Generated by Vivado on Fri Mar 10 12:14:07 +0530 2023
...
echo "xvlog --incr --relax -prj mux16btb_vlog.prj"
call xvlog  --incr --relax -prj mux16btb_vlog.prj -log xvlog.log
